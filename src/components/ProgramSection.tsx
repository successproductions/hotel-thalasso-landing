...
const programMeta: ProgramMeta[] = [
  ...
  { day: 2, icon: <Waves className="w-6 h-6"/>, gradient: 'from-blue-500 via-indigo-500 to-purple-500', image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?...' },
  { day: 3, icon: <Sparkles className="w-6 h-6"/>, gradient: 'from-violet-500 via-pink-500 to-rose-500', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?...' },
  { day: 4, icon: <Droplets className="w-6 h-6"/>, gradient: 'from-orange-500 via-amber-500 to-yellow-500', image: '/images/sauna_ritual.png' }
];
            ...
            return (
              <Card
                ...
                className={`
                  ...
                  hover:shadow-2xl hover:-translate-y-3 border-0 overflow-hidden
                  bg-white/10 backdrop-blur-sm
                  ${hoveredCard === meta.day ? 'scale-105 z-10' : ''}
                  ${selectedDay === meta.day ? 'ring-2 ring-white ring-offset-4 ring-offset-transparent' : ''}
                `}
                ...
                <div className="relative z-20 h-full flex flex-col">
                  <CardHeader className="text-white pb-4 flex-1">
                    ...
                    <div className={`space-y-3 mt-4 transition-all duration-500 ${
                        hoveredCard===meta.day||selectedDay===meta.day
