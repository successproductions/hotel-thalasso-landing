...
const programMeta: ProgramMeta[] = [
  ...
  { day: 3, icon: <Sparkles className="w-6 h-6"/>,    gradient: 'from-violet-500 via-pink-500 to-rose-500',  image: '/images/Restaurant.jpg' },
  { day: 4, icon: <Droplets className="w-6 h-6"/>,    gradient: 'from-orange-500 via-amber-500 to-yellow-500', image: '/images/Restaurant.jpg' }
];
