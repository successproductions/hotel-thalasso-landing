            ...
            <motion.div className="lg:col-span-2" variants={imageVariants}>
              ...
              >
                <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                  ...
                  <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/20 to-transparent p-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    <div className="text-white">
                      <p className="text-sm font-medium">Centre de thalassothérapie</p>
                      <p className="text-xs opacity-90">
                        Piscine thermale chauffée à l&apos;eau de mer
                      </p>
                    </div>
                  </div>
                </div>
