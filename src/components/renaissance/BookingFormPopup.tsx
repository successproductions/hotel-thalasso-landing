...
export default function BookingFormPopup({ isOpen, onClose }: BookingFormPopupProps) {
  ...
  // Internal translation data for popup content
  const popupTranslations = {
    fr: {
      offers: {
        '7': {
          title: 'THALASSO RENAISSANCE 7 JOURS',
          subtitle: 'Revitalisation Complète',
          includes: [
            '23 soins thalasso',
  ...
  // Offer static data - Fixed to program 7
  ...
  const selectedOfferData = tLocal.offers['7'];
  const currentOffer = {
    ...offerStaticData['7'],
        ...
        <div className="lg:grid lg:grid-cols-2"> 
          ...
          <div className="p-3 lg:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-2 lg:space-y-4">
              {/* Hidden Offer Selection - Fixed to "7" for Renaissance */}
              <input
                type="hidden"
                id="selectedOffer"
                name="selectedOffer"
