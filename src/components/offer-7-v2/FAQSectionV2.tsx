      ...
      <div className="relative py-12 md:py-14">
        ...
        >
          <motion.div className="md:mb-20 mb-5 text-center" variants={itemVariants}>
            ...
            >
              <h2 className="mb-4 text-3xl uppercase font-medium tracking-tight text-slate-800 dark:text-slate-100 md:text-5xl">
                {t('title')}
              </h2>
              <div className="mx-auto h-1 w-24 rounded-sm bg-slate-800 dark:bg-slate-100"></div>
            </motion.div>
          </motion.div>
              ...
              >
                <div className="relative overflow-hidden shadow-2xl md:rounded-sm">
                  <Image
                    ...
                    width={600}
                    height={400}
                    className="md:h-90 h-72 contrast-110 w-full object-cover filter md:h-fit"
                  />
                </div>
              </motion.div>
            </motion.div>
