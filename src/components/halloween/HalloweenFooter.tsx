          ...
          <div>
            ...
            <ul className="space-y-3" style={{ fontFamily: 'Futura, "Trebuchet MS", Arial, sans-serif' }}>
              <li className="flex items-center gap-3 text-gray-400 transition-colors">
                <Phone size={18} />
                <a href="tel:+212652881921" onMouseEnter={(e) => e.currentTarget.style.color = '#84bbca'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgb(156, 163, 175)'}>{t('footer.phone')}</a>
              </li>
              <li className="flex items-center gap-3 text-gray-400 transition-colors">
                <Mail size={18} />
                <a href="mailto:reservation@dakhlaclub.com" onMouseEnter={(e) => e.currentTarget.style.color = '#84bbca'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgb(156, 163, 175)'}>{t('footer.email')}</a>
              </li>
