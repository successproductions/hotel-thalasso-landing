          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-300 bg-gray-50 px-4 py-2.5 text-gray-800 focus:border-[#d6bb8e] focus:outline-none focus:ring-2 focus:ring-[#d6bb8e]/30"
              >
