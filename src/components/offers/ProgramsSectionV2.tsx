...
export function ProgramsSectionV2() {
      ...
      offers: [
        {
          ...
          price: 'Prix du programme : 4950 <b>MAD</b> / 495 <b>€</b>',
          intro: [
        ...
        },
        {
          ...
          price: 'Prix du programme : 9270 <b>MAD</b> / 927 <b>€</b>',
          intro: [
        ...
        },
        {
          ...
          price: 'Prix du programme : 10620 <b>MAD</b> / 1062 <b>€</b>',
          intro: [
      ...
      offers: [
        {
          ...
          price: 'Price of the program : 4950 <b>MAD</b> / 495 <b>€</b>',
          intro: [
        ...
        },
        {
          ...
          price: 'Price of the program : 9270 <b>MAD</b> / 927 <b>€</b>',
          intro: [
        ...
        },
        {
          ...
          price: 'Price of the program : 10620 <b>MAD</b> / 1062 <b>€</b>',
          intro: [
  ...
  const serviceDescriptions: Record<string, string> = {
    ...
    'Hammam secret desert': 'Rituel de hammam traditionnel du désert avec vapeur, gommage et relaxation dans une ambiance orientale authentique.',
    'Massage tonique': 'Massage dynamisant et tonifiant pour réveiller le corps, stimuler la circulation et relancer l\'énergie vitale.',
    'Massage dos': 'Massage ciblé du dos pour relâcher les tensions musculaires profondes, soulager les douleurs et améliorer la posture.',
    'Soin combleur hyalu procolagene': 'Soin visage à l\'acide hyaluronique et au procolagène pour combler les rides, lisser et repulper la peau en profondeur.',
    'Cupping thérapie dos': 'Technique de cupping ciblée sur le dos pour libérer les tensions musculaires, stimuler la circulation et favoriser la détoxification.',
    'Massage After kite': 'Massage récupérateur spécialement conçu pour les sportifs et kitesurfeurs, ciblant les zones de tension post-effort.',
    'Pédicure': 'Soin complet des pieds pour hydrater, exfolier et soigner les ongles, laissant les pieds doux et régénérés.',
    'Soin raffirmissant siliciuam lift': 'Soin corps raffermissant au silicium pour tonifier, lisser et redonner élasticité et fermeté à la peau.',
  };
  ...
  const programsData: Record<string, { services: ServiceItem[], availability: Record<string, number> }> = {
    'servicesTable': { // 3 days
      services: [
        ...
        { title: "Soin combleur hyalu procolagene" },
        { title: "Cupping thérapie dos" }
      ],
      availability: {
        "Bol d'air Jacquier": 3,
        "Hammam secret desert": 1,
        "Piscine thermale": 3,
        "Massage tonique": 1,
        "Massage dos": 1,
        "Bain hydromassant": 1,
        ...
        "Soin combleur hyalu procolagene": 1,
        "Cupping thérapie dos": 1
      }
    },
    'offer5.servicesTable5': { // 5 days
      services: [
        ...
        { title: "Pédicure" },
        { title: "Massage After kite" },
        { title: "Sauna" },
        { title: "Scrub detox sel Himalaya" },
        { title: "Massage detox sel Himalaya" },
        { title: "Massage pouchons" },
        { title: "Soin raffirmissant siliciuam lift" },
        { title: "Cupping + serviette de feu" }
      ],
      availability: {
        "Bol d'air Jacquier": 5,
        "Douche à jet": 3,
        "Piscine thermale": 5,
        "Ice bath": 1,
        ...
        "Modelage affusion": 1,
        "Pédicure": 1,
        "Massage After kite": 1,
        "Sauna": 1,
        "Scrub detox sel Himalaya": 1,
        "Massage detox sel Himalaya": 1,
        "Massage pouchons": 1,
        "Soin raffirmissant siliciuam lift": 1,
                ...
                >
                  <div className="mx-auto max-w-6xl px-6 py-4 md:px-4 font-extralight ">
                    ...
                    <div>
                      ...
                      <p 
                        className="text-[16px] md:text-lg leading-relaxed text-gray-700 mb-8"
                        dangerouslySetInnerHTML={{ __html: offer.price || '' }}
                      />
