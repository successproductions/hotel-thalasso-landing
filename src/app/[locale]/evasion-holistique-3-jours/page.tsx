...
export async function generateMetadata({
  ...
  const metadata3Days = {
    fr: {
      ...
      description:
        'Offrez-vous 3 jours de bien-être au centre DC Thermes à Dakhla. Cure détox, soins thalasso, spa entre désert et océan. Vitalité, clarté et énergie retrouvée.',
      keywords:
        'séjour bien-être Dakhla, cure détox Maroc, spa haut de gamme Maroc, centre thalasso Dakhla, reset corps esprit, soins detox corps et esprit, spa désert et océan, spa DC Thermes, programme bien-être 3 jours, séjour holistique Maroc',
    },
    en: {
      title: '3-Day Holistic Escape in Dakhla – Detox Cure & Wellness',
      description:
        'Treat yourself to 3 days of wellness at DC Thermes center in Dakhla. Detox cure, thalasso treatments, spa between desert and ocean. Vitality, clarity and renewed energy.',
      keywords:
        'Dakhla wellness stay, Morocco detox cure, luxury spa Morocco, Dakhla thalasso center, body mind reset, detox body mind treatments, desert ocean spa, DC Thermes spa, 3-day wellness program, holistic stay Morocco',
    },
  };
      ...
      <NewsletterSection />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Programme de bien-être holistique 3 jours combinant cure détox, soins thalasso et relaxation dans l'environnement unique de Dakhla entre désert et océan.",
            offers: {
              '@type': 'Offer',
