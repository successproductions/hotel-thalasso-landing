...
export async function generateMetadata({
  ...
  return {
    ...
    description: locale === 'fr' ? 'Votre réservation Thalasso Vitalité a été confirmée.' : 'Your Thalasso Vitalité reservation has been confirmed.',
    robots: { index: false, follow: false },
  };
}

export default async function VitaliteThankYouPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
