  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (paymentSuccess) {
        ...
        router.push(`/${locale}/evasion-5/payment-success`);
      } else {
        // Redirect to error page
        router.push(`/${locale}/evasion-5/payment-error`);
      }
    } catch (error) {
          ...
          <div className="grid gap-8 lg:grid-cols-[35%_65%]">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-sm bg-teal-50 p-6 border border-teal-100">
                <h4 className="mb-3 font-semibold text-gray-800">Pack Évasion 5</h4>
