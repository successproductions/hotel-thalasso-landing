...
export async function generateMetadata({
  ...
  const homepageMeta = {
    fr: {
      ...
      description: "Centre de thalassothérapie et bien-être à Dakhla. Séjours holistiques 3, 5 et 7 jours entre désert et océan. Détox, spa, yoga et méditation.",
      keywords: "centre thalasso Dakhla, retraite bien-être Maroc, spa Dakhla, cure détox Maroc, séjour wellness désert océan, thalassothérapie Maroc"
    },
    en: {
      title: "Dakhla Club - Wellness Retreats & Thalasso in Morocco", 
      description: "Thalassotherapy and wellness center in Dakhla. Holistic stays 3, 5 and 7 days between desert and ocean. Detox, spa, yoga and meditation.",
      keywords: "Dakhla thalasso center, Morocco wellness retreat, Dakhla spa, Morocco detox cure, desert ocean wellness stay, thalassotherapy Morocco"
    }
  };
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Centre de thalassothérapie et bien-être à Dakhla proposant des retraites holistiques entre désert et océan.",
            "potentialAction": {
              "@type": "SearchAction",
              "target": {
                "@type": "EntryPoint",
