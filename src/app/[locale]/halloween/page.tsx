...
export default async function HalloweenPage({
  ...
  return (
    <>
      {/* Google Tag Manager - Halloween Page */}
      <Script
        id="gtm-halloween"
        ...
        dangerouslySetInnerHTML={{
          ...
          })(window,document,'script','dataLayer','GTM-PHTBVLGW');`,
        }}
      />

      {/* Google Tag Manager (noscript) - Halloween Page */}
      <noscript>
        <iframe
          src="https://www.googletagmanager.com/ns.html?id=GTM-PHTBVLGW"
          height="0"
          width="0"
