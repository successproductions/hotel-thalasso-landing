...
export default function EvasionPanierPage() {
  ...
  const currentOffer = {
    title: locale === 'fr' ? "THALASSO ÉVASION 3 JOURS" : "THALASSO EVASION 3 DAYS",
    subtitle: locale === 'fr' ? "Évasion Holistique" : "Holistic Escape",
    includes: locale === 'fr'
  ...
  const currentPriceMAD = Math.floor(currentOffer.basePriceMAD * 1.027 * 10.90);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <header className="border-b border-gray-100 bg-white py-4 px-6 md:px-12 flex justify-between items-center z-10 sticky top-0">
        ...
        <a href={`/${locale}/${'evasion-holistique-3-jours'}`} className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors flex items-center gap-2">
