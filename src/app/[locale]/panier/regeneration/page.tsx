...
export default function RegenerationPanierPage() {
  ...
  const currentOffer = {
    title: locale === 'fr' ? "THALASSO RÉGÉNÉRATION 5 JOURS" : "THALASSO REGENERATION 5 DAYS",
    subtitle: locale === 'fr' ? "Retraite Revitalisante" : "Revitalizing Retreat",
    includes: locale === 'fr'
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <header className="border-b border-gray-100 bg-white py-4 px-6 md:px-12 flex justify-between items-center z-10 sticky top-0">
        ...
        <a href={`/${locale}/${'regeneration'}`} className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors flex items-center gap-2">
