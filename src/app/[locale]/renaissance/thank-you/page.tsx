...
export async function generateMetadata({
  ...
  return {
    ...
    description: locale === 'fr' ? 'Votre réservation Thalasso Renaissance a été confirmée.' : 'Your Thalasso Renaissance reservation has been confirmed.',
    robots: { index: false, follow: false },
  };
}

export default async function RenaissanceThankYouPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
