...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <strong>Évasion Holistique – 7 jours</strong> au Dakhla Club Hotel & Spa.</p>
      ...
      <div style="text-align: center;">
        <a href="https://offer.dakhlaclub.com/fr/evasion-7" class="button">Consulter les détails du séjour</a>
      </div>
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p style="margin: 10px 0 0 0;">Évasion Holistique 7 Jours</p>
    </div>
    <div class="content">
      <div class="urgent">
  ...
  try {
    ...
    try {
      await transporter.sendMail({
        ...
        subject: '🔔 Nouvelle demande de réservation - Évasion Holistique 7 Jours',
